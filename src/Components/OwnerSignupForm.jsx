...
import { Signupownerr } from "@/services/ownerservice";
...
const SignupForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const result = await Signupownerr(formData);
            ...
            <div className="max-w-md w-full space-y-8">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Or
                        <span onClick={gotologinowner} className="font-medium cursor-pointer text-blue-600 hover:text-blue-500"> log in if you already have an account</span>
                    </p>
                </div>
